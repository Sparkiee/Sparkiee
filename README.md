...
☕ Fueled by coffee • Driven by curiosity • Focused on creating impactful systems

---

## 🚀 About Me
I'm a passionate developer with a love for **building dynamic applications** — from scalable **web platforms** to immersive **game projects**.  
I thrive where creativity meets logic: whether it's crafting **backend architectures**, designing **modern frontends**, or integrating **DevOps workflows**.

- 🔭 Currently exploring **MERN stack**, **TypeScript**, and **microservice architecture**
- 🧠 Learning more about **AI integrations**, **Redis optimization**, and **scalable APIs**
- 🎮 Developing indie games in **Unity (C#)** during my spare time
- 💬 Always open to collaborating on meaningful open-source or dev-tools projects
